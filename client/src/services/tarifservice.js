...
const url = 'http://localhost:5000/api/tarif/';
...
class masallarservice {
    ...
    //ileti guncelle(PUT)
    static updateTarif(id, name, desc, nameEn, descEn, showInPage, startDate, endDate, row_number) {
