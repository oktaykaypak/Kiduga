...
const url = 'http://localhost:5000/api/haftalikbebekgelisimi/';

class haftalikbebekgelisimiservice {
    ...
    //ileti guncelle(PUT)
    static updateData(id, name, desc, nameEn, descEn, row_number) {
...
export default haftalikbebekgelisimiservice;