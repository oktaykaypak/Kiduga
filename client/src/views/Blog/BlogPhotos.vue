    ...
    <div class="row">
      <div class="col">
        <md-button
          ...
          style="margin-right: 1% !important; margin-left: 39% !important; width: 10%"
          @click="Add"
          >Yükle</md-button
        >
        ...
        <md-button
          ...
          style="margin-right: 39% !important; margin-left: 1% !important; width: 10%"
          @click="Delete"
          >Sil</md-button
        >
      </div>
...
export default {
  ...
  methods: {
    ...
    async Add() {
      if (this.file != null) {
        try {
          ...
          await blogservice.addPhoto(this.id, this.img_url);
    ...
    async Delete() {
      await blogservice.deletePhoto(this.id);
      window.location.reload(1);
    },
    authorization() {
      let token = {
    ...
    async GetOyuncaklar(id) {
      this.oyuncaklar = await blogservice.getData2(id);
