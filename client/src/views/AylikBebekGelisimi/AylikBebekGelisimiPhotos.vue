...
export default {
  ...
  methods: {
    ...
    async Add() {
      if (this.file != null && this.file != undefined && this.file != "") {
        ...
        try {
          ...
          await aylikbebekgelisimiservice.addPhoto(
            this.id,
            this.img_url,
            this.type,
            this.row_number
    ...
    async Delete(photoId) {
      await aylikbebekgelisimiservice.deletePhoto(this.id, photoId);
      window.location.reload(1);
    },
    async Update(photoId) {
      await aylikbebekgelisimiservice.updatePhoto(
        this.id,
        photoId,
        this.type,
        this.row_number
    ...
    async GetOyuncaklar(id) {
      this.oyuncaklar = await aylikbebekgelisimiservice.getData2(id);
