  ...
  <div>
    ...
    <div v-else>
      <div class="row" style="margin-bottom: 10px">
          <h1 style="width: 85%;margin-left:2%">Müzik Listesi</h1>
          <button
            style="font-size: 18px; width: 10%;height:70%"
            class="btn btn-success"
            @click="$router.push('/muzikler/muzikekle')"
          >
            Ekle
          </button>
      </div>
      <div>
        ...
        >
          <md-table-row>
            ...
            <md-table-cell class="table-title"> Müzik Adı </md-table-cell>
          ...
          >
            ...
            >
              <router-link
                ...
                :to="`/muzikler/muzikduzenle?id=${masal._id}`"
                style="width: 45%"
                >Düzenle</router-link
              >
              <span
...
export default {
  ...
  methods: {
    ...
    async GetMasallar() {
      ...
      this.masallar = await muzikservice.getData();
      this.isLoading = false;
    },
    async Delete(id) {
      await muzikservice.deleteData(id);
