  ...
  <div>
    ...
    <div v-else>
      <div class="row" style="margin-bottom: 10px">
        <h1 style="width: 85%; margin-left: 2%">Masal Listesi</h1>

        <button
          style="font-size: 18px; width: 10%; height: 70%"
          class="btn btn-success"
          @click="$router.push('/masalislemleri/masallarekle')"
        >
          Ekle
        </button>
      </div>
      <div>
        ...
        >
          <md-table-row>
            ...
            <md-table-cell class="table-title"> Masal Adı </md-table-cell>
          ...
          >
            ...
            >
              <router-link
                ...
                :to="`/masalislemleri/masallarduzenle?id=${masal._id}`"
                style="width: 45%"
                >Düzenle</router-link
              >
              <span
...
export default {
  ...
  methods: {
    async GetMasallar() {
      this.masallar = await masallarservice.getData();
    ...
    async Delete(id) {
      await masallarservice.deleteData(id);
