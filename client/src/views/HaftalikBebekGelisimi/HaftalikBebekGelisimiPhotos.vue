...
export default {
  name: "HaftalikBebekGelisimiPhotos",
  components: {
    VclFacebook,
    VclInstagram,
  },
  ...
  methods: {
    ...
    async Add() {
      if (this.file != null && this.file != undefined && this.file != "") {
        ...
        try {
          ...
          await haftalikbebekgelisimiservice.addPhoto(
            this.id,
            this.img_url,
            this.type,
            this.row_number
    ...
    async Delete(photoId) {
      await haftalikbebekgelisimiservice.deletePhoto(this.id, photoId);
      window.location.reload(1);
    },
    async Update(photoId) {
      await haftalikbebekgelisimiservice.updatePhoto(
        this.id,
        photoId,
        this.type,
        this.row_number
    ...
    async GetOyuncaklar(id) {
      this.oyuncaklar = await haftalikbebekgelisimiservice.getData2(id);
